  ...
  return (
    <section id="contato" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="glass rounded-3xl p-8 md:p-16 max-w-5xl mx-auto border border-surface-border relative overflow-hidden">
          {/* Internal glow */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-muted mb-2">E-mail Corporativo</label>
                <input
                  type="email"
                  id="email"
                  className="w-full bg-surface border border-surface-border rounded-lg px-4 py-3 text-white focus:outline-none focus:border-primary transition-colors"
              ...
              <button
                type="button"
                className="w-full bg-primary hover:bg-primary-hover text-white font-medium py-4 rounded-lg transition-all glow-primary-hover"
              >
                Solicitar Contato
              </button>
            </motion.form>
